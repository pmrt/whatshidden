...
export const TOO_MANY_ATTEMPTS_TO_RECOVER_SESSION = "Too many attempts to recover session: session unrecoverable. You may be using WhatsApp Web on another device too much (WhatsApp Web only allows 1 session at a time) or an unrecoverable error has occurred";
